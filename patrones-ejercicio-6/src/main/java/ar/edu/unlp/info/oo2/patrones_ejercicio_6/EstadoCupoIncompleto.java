...
public class EstadoCupoIncompleto extends EstadoCupo {
	...
	public String obtenerInformacion(Excursion excursion) {
		...
		builder.append("Nombre de la excursion: " + excursion.getNombre())
			   ...
			   .append("Cantidad de usuarios faltantes para el cupo minimo: " + excursion.getCantidadDeUsuariosFaltantesParaElCupoMinimo().toString());
